...
namespace DesFirePersonalizer
{
    public partial class MainPage : Form
    {
        ...
        private void disableitems()
        {
            ...
            {
                if (item.Name != "logOutToolStripMenuItem" && item.Name != "homeToolStripMenuItem" && item.Name != "enToolStripMenuItem" && item.Name != "languageToolStripMenuItem")
                {
                    item.Visible = false;
                }
            }
        ...
        private void languageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                case "en-US": Thread.CurrentThread.CurrentUICulture = new System.Globalization.CultureInfo("ar-SA"); break;
                    //// case "ar-SA": Thread.CurrentThread.CurrentUICulture = new System.Globalization.CultureInfo("en-US"); break;
                    // default:
                    //     break;
            }
            this.Controls.Clear();
        ...
        
        private void selectReaderToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ReaderSettingsFRM rfm = new ReaderSettingsFRM();
            rfm.ShowDialog();
        ...
        private void CardReaderComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (CardReaderList != null && CardReaderList.Length >= 1)
            {
                int index = CardReaderComboBox.SelectedIndex;
